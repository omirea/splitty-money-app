...
public class AddQuoteCtrl {
    ...
    private final RefMainCtrl refMainCtrl;
    ...
    @Inject
    public AddQuoteCtrl(RefServerUtils server, RefMainCtrl refMainCtrl) {
        this.refMainCtrl = refMainCtrl;
        this.server = server;
