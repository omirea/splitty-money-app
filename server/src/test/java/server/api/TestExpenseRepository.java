...
public class TestExpenseRepository implements ExpenseRepository {
     ...
     * This kind of operation leaves JPAs
     * first level cache and the database out of sync.
     * Consider flushing the {@link EntityManager} before calling this
     * method.
     * <p>
     ...
     * This kind of operation leaves JPAs first
     ...
     * Depending on how the JPA persistence provider is
     * implemented this is very likely to always return an instance and throw an
     * {@link EntityNotFoundException} on first access.
     * Some of them will reject invalid identifiers
     * immediately.
     *
     * @param aLong must not be {@literal null}.
     ...
     * @return a single entity matching the given {@link Example}
     * or {@link Optional#empty()} if none was found.
     ...
     *                Must not be {@literal null}.
     * @return {@literal true} if the data store contains
     * elements that match the given {@link Example}.
     */
    @Override
    ...
    /**
     * Returns entities matching the given {@link Example}
     * applying the {@link Function queryFunction} that defines the
     ...
     * @throws IllegalArgumentException
     * in case the given {@link Iterable entities} or one of its entities is
     *                                           {@literal null}.
     * @throws OptimisticLockingFailureException
     * when at least one entity uses optimistic locking and has a version
     *
     ...
     * The size can be equal or less than the number of given
     * {@literal ids}.
     * @throws IllegalArgumentException in case the given
     * {@link Iterable ids} or one of its items is {@literal null}.
     */
    @Override
     ...
     * @throws IllegalArgumentException in case the given
     * {@literal ids} or one of its elements is {@literal null}.
     * @since 2.5
     */
    @Override
     ...
     * Must not contain {@literal null} elements.
     * @throws IllegalArgumentException
     * in case the given {@literal entities} or one of its entities is {@literal null}.
     * @throws OptimisticLockingFailureException
     * when at least one entity uses optimistic locking and has a version
     * attribute with a different value from that found in the persistence store.
     * Also thrown if at least one
